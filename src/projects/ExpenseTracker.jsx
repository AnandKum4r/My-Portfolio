      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        <div className="order-2 sm:order-1 w-full">
          ...
          <p className="text-justify text-sm md:text-base mt-2">
            The Expense Tracker is a simple and interactive web application built
            using HTML, CSS, and JavaScript. It allows users to track their
            expenses by adding, updating, and deleting expense entries.
          </p>
        ...
        <a
          href="https://github.com/AnandKum4r/Expense-Tracker"
